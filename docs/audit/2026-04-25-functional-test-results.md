...
当前项目已经具备较完整的产品骨架：文档库、阅读器、卡片工坊、复习、知识问答、播客、知识图谱、统计、BYOK 设置、Tauri 后端、Python orchestration service 都已存在。
...
| 10. 知识图谱                            | 图谱 UI、gateway、Rust command、workflow、schema 都存在                                             | 黄     |
