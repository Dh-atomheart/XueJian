...
export function PageNavBar({
  ...
  return (
    <aside className="flex h-full min-h-0 flex-col rounded-[28px] border border-line-soft bg-[linear-gradient(180deg,rgba(249,247,240,0.95),rgba(242,239,230,0.98))] shadow-paper">
